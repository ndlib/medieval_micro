  ...
  configure_blacklight do |config|
    ...
    config.default_solr_params = {
      ...
      :qf => [
        ...
        'city_facet',
        'shelf_mark_s',
        'alternate_names_s',          # Facsimile specific fields
        'origin_s',
        ...
        'hand_s',
        'illuminations_facet',
        'type_of_decoration_s',
        'musical_notation_facet',
        'type_of_musical_notation_s',
        'call_number_s',
        'commentary_volume_facet',
        'nature_of_facsimile_s',
        'series_s',
        'publication_date_s',
        'place_of_publication_s',
        'publisher_s',
        'printer_s',
        'notes_s',
        'bibliography_s',
        'classification_facet',
        'mss_name_s',                 # Microfilm specific fields
        'mss_note_s',
        'collection_facet',
        'reel_s',
        'hesburgh_location_s',
